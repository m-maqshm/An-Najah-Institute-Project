...
// Academic Qualification: $academicQualtif
// Date of Birth: $dateOfBarth
// ''');

    try {
      await userVM.fetchUserProfileFromAPI(token: storageHelper.readKey('token'));
      print (storageHelper.readKey('arabicName'));
      Map<String, dynamic> userData = {
        ...
        'DOB':dateOfBarth??storageHelper.readKey('dateOfBirth'),
        // 'photo': profilePicture ?? storageHelper.readKey('profilePicture'),
        'token': storageHelper.readKey('token'),  // إرفاق الـ token للتوثيق
      };
