...
class Cors___Screen extends StatelessWidget {
  final GlobalKey<ScaffoldState> scaffoldKey = GlobalKey<ScaffoldState>();
String namedp ,  img;
   int dpId;
  Cors___Screen({super.key,required this.namedp ,required this.dpId, required this.img});
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    ...
                    Expanded(
                        child: FutureBuilder(
                            future: cvm.getCrentCours(x: dpId),
