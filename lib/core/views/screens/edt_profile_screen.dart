...
/*             Container(
               ...
               child: Text('lable' , style: TextStyle(fontFamily: "shahdFont" , fontSize: 16)))*/
                                    ...
                                    children: [
                                      ...
                                      Container(
                                          child: birthday == null
                                              ...
                                              style: TextStyle(
                                                  fontFamily: "shahdFont", fontSize: 16))),
                                    ],
                                  )),
                            ],
                          )),
                    ...
                    BottonScreen(
                      text: "حفظ",
                      method: () async{
                        // print(degreeController);
                        // print("birthday:" +birthday!.split(" ").toList().removeAt(0));
                        if (_frmKey.currentState!.validate() == true) {
                          await profileVM.updateUserProfileAPI(
                            token: storageHelper.readKey('token'),
                            address: addressController.text.isEmpty ? null : addressController.text,
                            // arabicName: nameArabicController.text.isEmpty ? null : nameArabicController.text,
                            englishName: nameEnglishController.text.isEmpty ? null : nameEnglishController.text,
