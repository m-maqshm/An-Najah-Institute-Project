      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            Text('$title  : ',style: TextStyle(fontFamily: "shorog",fontSize: 15,fontWeight: FontWeight.normal, color: Colors.black),textAlign: TextAlign.right,textDirection: TextDirection.rtl,),
            Text(text=='null'?"لم يتم التحديد بعد":'${text }',style: TextStyle(fontFamily: "shorog",fontSize: 15,fontWeight: FontWeight.normal, color: Colors.black),textAlign: TextAlign.right,textDirection: TextDirection.rtl,                                                    overflow: TextOverflow.ellipsis,
                ),
